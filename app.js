new Vue({
    ...
    data: {
        totalPoints: 38,
        stats: [
            { name: 'Strength', abbr: 'STR', icon: 'fa-solid fa-hand-fist', value: 1 },
            ...
            { name: 'Intelligence', abbr: 'INT', icon: 'fa-solid fa-brain', value: 1 },
    ...
    methods: {
        ...
        validatePoints() {
            let totalUsedPoints = this.stats.reduce((acc, stat) => acc + stat.value, 0);
